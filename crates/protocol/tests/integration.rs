...
use protocol::{
    ...
    Message, MessagePayload, ProtocolVersion, RequestId, TransferResult, TransferType, UsbError,
    UsbRequest, UsbResponse, decode_framed, decode_message, encode_framed, encode_message,
    validate_version,
};
use std::io::Cursor;
